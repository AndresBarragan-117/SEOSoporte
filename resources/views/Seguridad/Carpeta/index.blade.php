...
<div>
	...
	<form action="{{ url('carpeta')}}" role="form" class="form-horizontal" method="POST" accept-charset="utf-8">
		...
		<div style="margin-left:6px;margin-bottom: 12px;">
			...
			<a title="Consultar" href="{{ url('carpeta/show') }}" class="btn btn-info" ><span class=" fa fa-search" ></span></a>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<form class="formDelete" action="{{ route('carpeta.destroy', $dt->idCarpeta) }}" method="POST">
								<input type="hidden" value="DELETE" name="_method">
								{{ csrf_field() }}
								<a title="Editar" href="{{ $dt->idCarpeta.'/edit'}}" class="btn btn-success btn-xs"><span class="fa fa-check"></span></a>
...
<script type="text/javascript" charset="utf-8" >
	...
	$(".formDelete").submit(function(e)
	{
		...
		if(!confirm("Está seguro de eliminar esta Carpeta?"))
		{
			e.preventDefault();	
		}
