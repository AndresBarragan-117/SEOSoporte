...
<div>
	...
	<form action="{{ route('categoria.update', $edit->idCategoria)}}" role="form" class="form-horizontal" method="POST" accept-charset="utf-8">
			...
			<div role="tabpanel" class="tab-pane active" id="form">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<input name="codigo" id="codigo" class="form-control" value="{{$edit->codigo}}"></input>
