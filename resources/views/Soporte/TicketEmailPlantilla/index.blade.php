...
<div>
	...
	<form action="{{ url('ticketEmailPlantilla')}}" role="form" class="form-horizontal" method="POST" accept-charset="utf-8">
		{{ csrf_field() }}
		...
		<div style="margin-left:6px;margin-bottom: 12px;">
			...
			<a href="{{ url('ticketEmailPlantilla/show') }}" class="btn btn-info" title="Consultar"><span class=" fa fa-search" ></span></a>
			...
			<div role="tabpanel" class="tab-pane active" id="form">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<textarea rows="10" name="contenido" id="contenido" class="form-control">{{old('contenido')}}</textarea>
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$dt->asunto}}</td>
						<td>
							<form id="formDelete" action="{{ route('ticketEmailPlantilla.destroy', $dt->idTicketEmailPlantilla) }}" method="POST">
								<input type="hidden" value="DELETE" name="_method">
								{{ csrf_field() }}
								<a href="{{ $dt->idTicketEmailPlantilla.'/edit'}}" class="btn btn-success btn-xs"><span class="fa fa-check"></span></a>
