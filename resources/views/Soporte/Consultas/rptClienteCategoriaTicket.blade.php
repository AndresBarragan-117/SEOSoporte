...
@section('titulo', 'Rpte. Clientes Categoría Ticket')
@section('cuerpo')
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function() {
        ...
        $("#btnDescargarGrafica").click(function () {
            if(imgUri != null) {
                filee(imgUri, "rptClienteCategoriaTicket.png", "image/png");
            }
        });
    });
    ...
    function consultar()
	{
        ...
        $.get('{{ url("/ticketSoporte/rptClienteCategoriaTicket")}}/1/'+ fechaInicio+ '/'+ fechaFin + '/' + idEmpresa + '/' + idCategoria,function(data)
        {
