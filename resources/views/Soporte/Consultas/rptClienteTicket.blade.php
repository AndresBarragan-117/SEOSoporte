...
<script type="text/javascript" charset="utf-8" >
    ...
    $(function() {
        ...
        $("#btnDescargarGrafica").click(function () {
            if(imgUri != null) {
                filee(imgUri, "rptClienteTicket.png", "image/png");
            }
        });
    ...
    function consultar()
	{
        ...
        $.get('{{ url("/ticketSoporte/rptClienteTicket")}}/1/'+ fechaInicio+ '/'+ fechaFin + '/' + idEmpresa,function(data)
        {
    ...
    function drawChart()
    {
        ...
        var options = {
            title : 'Cientes x cantidad de tickets',
            width:800,
            height:400
        };
