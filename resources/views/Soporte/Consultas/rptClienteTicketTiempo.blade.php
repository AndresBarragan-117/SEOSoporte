...
@section('titulo', 'Rpte. Clientes Tiempo')
@section('cuerpo')
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function() {
        ...
        $("#btnDescargarGrafica").click(function () {
            if(imgUri != null) {
                filee(imgUri, "rptClienteTicketTiempo.png", "image/png");
            }
        });
    });
    ...
    function consultar()
	{
        ...
        $.get('{{ url("/ticketSoporte/rptClienteTicketTiempo")}}/1/'+ fechaInicio+ '/'+ fechaFin + '/' + idEmpresa,function(data)
        {
    ...
    function drawChart()
    {
        ...
        var options = {
            title : 'Cientes x tiempo de tickets',
            width:900,
            height:500,
