...
@section('titulo', 'Rpte. Clientes Categoría Ticket Tiempo')
@section('cuerpo')
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function() {
        ...
        $("#btnDescargarGrafica").click(function () {
            if(imgUri != null) {
                filee(imgUri, "rptClienteCategoriaTicketTiempo.png", "image/png");
            }
        });
    });
    ...
    function consultar()
	{
        ...
        $.get('{{ url("/ticketSoporte/rptClienteCategoriaTicketTiempo")}}/1/'+ fechaInicio+ '/'+ fechaFin + '/' + idEmpresa + '/' + idCategoria,function(data)
        {
    ...
    function drawChart()
    {
        ...
        var options = {
            title : 'Clientes por categoría por tiempo',
            vAxis: {title: 'Tiempo(Horas)'},
            hAxis: {title: 'Cliente'},
            seriesType: 'bars',
