...
(function($){
            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '        </div>'
                        +    '        <div id="ptTimeSelectSetButton" style="display:none">'
                    ...
                    e.find('.ptTimeSelectMin')
                        .bind("click", function(){
                            ...
                            jQuery.ptTimeSelect.setTimeInstant();
    ...
    //Asignar hr al campo.
    jQuery.ptTimeSelect.setTimeInstant = function () {
        var tSel = jQuery('#ptTimeSelectUserSelHr').text()
                    + ":"
                    + jQuery('#ptTimeSelectUserSelMin').text()
                    + " "
                    + jQuery('#ptTimeSelectUserSelAmPm').text();
        jQuery(".isPtTimeSelectActive").val(tSel);
        jQuery(".isPtTimeSelectActive").trigger("change");


    };
    // END setTimeInstant() function
